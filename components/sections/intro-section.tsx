		...
		>
			...
			>
				...
				<motion.h1
					...
					className="md:text-7xl sm:text-5xl text-4xl font-bold"
				>
					<AuroraText speed={2}>AI Enthusiast</AuroraText>
				</motion.h1>
				<motion.h1
					initial={{ opacity: 0, x: -50, filter: "blur(5px)" }}
					whileInView={{ opacity: 1, x: 0, filter: "blur(0px)" }}
			...
			<div className="flex w-full flex-col items-center justify-center">
				...
				<div className="relative w-full overflow-hidden">
					<VelocityScroll defaultVelocity={2}>
						Frontend • Backend • AI systems • Machine Learning •
						Data Pipelines • LLM Agents • Cloud Deployment • API • 
					</VelocityScroll>
